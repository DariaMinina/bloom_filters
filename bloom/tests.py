...
from bloom.bloom import BloomFilter, ScalableBloomFilter
from bloom.utils import running_python_3, range_fn
...
def additional_tests():
    ...
    suite = TestSuite([doctest.DocTestSuite('bloom.bloom')])
